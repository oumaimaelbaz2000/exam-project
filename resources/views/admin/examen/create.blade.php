        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.examan.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.examen.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('duration') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="duration" id="duration" value="{{ old('duration') }}" required>
