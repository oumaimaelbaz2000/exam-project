                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('option_a') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="option_a" id="option_a" value="{{ old('option_a', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('option_b') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="option_b" id="option_b" value="{{ old('option_b', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('option_d') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="option_d" id="option_d" value="{{ old('option_d', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('subjects') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="subjects_id" id="subjects_id" required>
                                @foreach($subjects as $id => $entry)
                                    <option value="{{ $id }}" {{ old('subjects_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
